...
const defaultTapTransition = { type: 'spring', stiffness: 540, damping: 34, mass: 0.7 }

export function Button({ className, variant, size, disabled, style, whileTap, transition, ...props }) {
  return (
    <motion.button
      disabled={disabled}
