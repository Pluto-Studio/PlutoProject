...
import plutoproject.feature.sit.api.paper.block.*
import plutoproject.feature.sit.api.paper.block.events.PlayerSitOnBlockEvent
import plutoproject.feature.sit.api.paper.block.events.PlayerStandUpFromBlockEvent
import plutoproject.feature.sit.paper.block.strategies.*
import plutoproject.feature.sit.paper.playSitSound
import plutoproject.foundation.common.collection.toImmutable
import plutoproject.foundation.paper.world.subtract
...
class BlockSitImpl : InternalBlockSit {
    private val seatEntityMarkerKey = NamespacedKey(
        (currentModuleContext() as PaperModuleContext).plugin,
        "sit.block_sit_marker",
    )
