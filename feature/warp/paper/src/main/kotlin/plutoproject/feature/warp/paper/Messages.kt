...
import plutoproject.foundation.common.text.replace as replacePlaceholder
import plutoproject.feature.warp.paper.aliasOrName

val WARP_TELEPORT_SUCCEED_SOUND = sound {
        ...
        component {
            raw(
                UI_WARP_ITEM_LORE_LOC
                    .replacePlaceholder("<world>", loc.world.aliasOrName)
                    .replacePlaceholder("<x>", "${loc.blockX}")
                    .replacePlaceholder("<y>", "${loc.blockY}")
                    .replacePlaceholder("<z>", "${loc.blockZ}")
            )
        },
        Component.empty(),
        component {
