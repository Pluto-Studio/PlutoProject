...
import plutoproject.feature.exchangeshop.paper.COMMAND_EXCHANGE_SHOP_TRANSACTIONS_SHOP_USER_NOT_FOUND
...
object ShopUserParser : FutureArgumentParser<CommandSender, ShopUser>, BlockingSuggestionProvider<CommandSender> {
    ...
    override fun parseFuture(
    ...
    ): CompletableFuture<ArgumentParseResult<ShopUser>> = moduleScope.async {
        ...
        val shopUser = plutoproject.kernel.api.koinGet<ExchangeShop>().getUser(player)
