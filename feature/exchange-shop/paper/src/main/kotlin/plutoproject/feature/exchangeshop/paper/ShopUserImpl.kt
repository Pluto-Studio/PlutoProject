...
import plutoproject.feature.exchangeshop.api.paper.*
import plutoproject.feature.exchangeshop.paper.models.TransactionModel
...
class ShopUserImpl(
    ...
    private suspend fun doTransaction(
        ...
        val databaseResult = withContext(Dispatchers.Loom) {
            plutoproject.kernel.api.koinGet<MongoConnection>().withTransaction {
        ...
        server.vaultEconomy!!.withdrawPlayer(player, cost.toDouble())
        updateTicketRecoverySchedule()
